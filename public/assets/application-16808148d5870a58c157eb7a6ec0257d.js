...
;
(function() {
  var set_click_handler, switch_avatar_upload;

  switch_avatar_upload = function() {
    if ($('#user_use_provider_avatar').size() > 0) {
      if (document.getElementById('user_use_provider_avatar').checked) {
        return $('#avatar_upload').hide('fast');
      } else {
        return $('#avatar_upload').show('fast');
      }
    }
  };
  ...
  set_click_handler = function() {
    if ($('#user_use_provider_avatar').size() > 0) {
      return $('#user_use_provider_avatar').click(function() {
        return switch_avatar_upload();
      });
    }
  };
