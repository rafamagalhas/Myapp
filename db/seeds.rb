...
ramdom_01 = User.create({name: 'Mr. Ramdom', email: @ramdoms[0] , image_url: generate_avatar_url(0)})
ramdom_02 = User.create({name: 'Crazy Fella', email: @ramdoms[1] , image_url: generate_avatar_url(1)})
ramdom_03 = User.create({name: 'Jujubees', email: @ramdoms[2] , image_url: generate_avatar_url(2)})
...
answer_02 = Answer.create({user: ramdom_01, question: question_01, content: 'Conteúdo resposta 02'})
